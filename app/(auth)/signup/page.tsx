...
import { UpdateFormSchema } from "@/Helper/validate";
    ...
    <div className="flex min-h-screen bg-gray-50 dark:bg-black">
      <div className="m-auto w-full max-w-md p-6 bg-white dark:bg-gray-900 shadow rounded-lg">
        ...
        <div className="mt-6 text-end"> <span>
          ...
          <a onClick={() => redirect("/signin", RedirectType.push)} className="cursor-pointer py-2 px-2 hover:text-blue-800 dark:hover:text-blue-800">
            Signin
          </a>
        </div>
      </div>
